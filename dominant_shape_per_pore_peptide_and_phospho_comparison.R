# ============================================================
# DOMINANT EVENT SHAPES PER PORE / PER PEPTIDE
# + GLOBAL CLUSTERING
# + PHOSPHO vs NON-PHOSPHO COMPARISON
# ============================================================
#
# PURPOSE
#   1) Read every *_nanopore_R_data_event_shapes.csv under one root folder.
#   2) Keep events with:
#        dwell time >= 0.5 ms
#        Ires between 20 and 85 %
#   3) Build GLOBAL waveform-shape clusters shared across all peptides.
#   4) For EACH PORE:
#        - identify the most frequent global shape cluster
#        - show real traces from that dominant population
#        - show the pore median waveform in black
#   5) For EACH PEPTIDE:
#        - identify the dominant global shape cluster using pore-balanced
#          proportions
#        - calculate a pore-balanced consensus waveform
#        - show the individual pore median shapes in grey
#        - show the peptide consensus in black
#   6) Compare phospho / non-phospho pairs:
#        - overlay their dominant peptide shapes
#        - show their cluster proportions beside the waveforms
#   7) Save CSV summaries and figures.
#
# IMPORTANT
#   - Global cluster labels have the SAME meaning for every peptide/pore.
#   - Clustering is based on NORMALISED waveform FORM.
#   - Displayed waveforms use the actual I/I0 traces.
#   - Peptide proportions are pore-balanced so one very event-rich pore
#     does not dominate a peptide.
#
# ============================================================
